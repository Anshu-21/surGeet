...
//   return (
//     <div className="grid grid-cols-4 gap-8 p-8 bg-gray-900 min-h-screen text-white">
//       {/* Sidebar for recordings */}
//       <div className="col-span-1 bg-gray-800 p-6 rounded-lg flex flex-col justify-between">
...
import { MusicProvider } from "./pages/MusicContext"; // Import MusicProvider
...
function App() {
  ...
  return !loading ? (
    <MusicProvider> {/* Wrap the entire app in MusicProvider */}
      <div
        style={{
